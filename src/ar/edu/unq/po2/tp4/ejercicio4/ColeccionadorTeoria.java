...
public class ColeccionadorTeoria {
	...
	2)AddLast funcionará con las listas, ya que al agregar un elemento va 
	directamente al final.



	3)GetSubCollection también con las listas, devuelve una parte de la colección
	 desde el índice marcado hasta índice2.
	...
	5)Es posible en las colecciones tanto usar Clases como Interfaces.*/
}
